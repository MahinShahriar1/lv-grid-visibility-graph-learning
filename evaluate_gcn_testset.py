...
# ============================================================
SAVED_TIMESERIES_DIR = Path("outputs") / "saved_timeseries"
...
# ------------------------------------------------------------
try:
    from load_gcn_data import StaticVoltageLoader  # type: ignore
except ImportError:
    print("=" * 50)
    print("ERROR: Could not find 'load_gcn_data.py'")
    print("Please keep load_gcn_data.py in the same directory.")
    print("=" * 50)
    raise
