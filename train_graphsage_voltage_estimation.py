...
# PHASE = 'A'
# HRRSM_NODES = [
#     3, 4, 5, 10, 11, 13, 23, 24, 25, 27, 28, 31, 33,
#     55, 56, 57, 62, 63, 66, 73, 79, 97, 101, 105, 123, 126, 134, 136, 148, 149,
#     159, 165, 166, 169, 197, 205, 206, 212, 213, 217, 231, 233, 234, 235, 249,
#     253, 261, 269, 277, 278, 279, 282, 283, 289, 290, 291, 292, 293, 322, 323,
#     331, 332, 333, 339, 344, 345, 346, 371, 372, 373, 374, 376, 377, 378, 379,
#     382, 383, 385, 398, 399, 403, 408, 409, 414, 421, 422, 425, 432, 437, 450,
#     451, 452
# ]
random.seed(42)
...
save_path = f'best_model_static_graphsage_testpyG_Phase{PHASE}.pt'
early_stopper = EarlyStopping(patience=20, path=save_path)
num_epochs = 1000


LOG_DIR = "training_logs_test3"
